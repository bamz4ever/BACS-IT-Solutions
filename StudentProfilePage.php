...
<body>
			...
			<div class="section-top-border">
				<div class="row">
					<div class="col-lg-8 col-md-8">
						...
						<h3 class="mb-30"><?php echo "Name: " . $fname . " " . $lname;?></h3>
						<h3 class="mb-30">Program</h3>
					<p class="sample-text">
					<?php echo $disc; ?>
					</p>
    ...
    <footer class="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget wow fadeInUp animated" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s;">
                    ...
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget wow fadeInUp animated" data-wow-duration="1.1s" data-wow-delay=".4s" style="visibility: visible; animation-duration: 1.1s; animation-delay: 0.4s;">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".5s" style="visibility: hidden; animation-duration: 1.2s; animation-delay: 0.5s; animation-name: none;">
                            <h3 class="footer_title">
                                Category
                            </h3>
                            <ul>
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1.3s" data-wow-delay=".6s" style="visibility: hidden; animation-duration: 1.3s; animation-delay: 0.6s; animation-name: none;">
                            <h3 class="footer_title">
                                Subscribe
                            </h3>
        ...
        <div class="copy-right_text wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".3s" style="visibility: hidden; animation-duration: 1.4s; animation-delay: 0.3s; animation-name: none;">
            <div class="container">
